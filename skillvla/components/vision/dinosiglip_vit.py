...
Copied from prismatic/models/backbones/vision/dinosiglip_vit.py
"""
...
from skillvla.components.vision.base_vision import ImageTransform, LetterboxPad, VisionBackbone, unpack_tuple
