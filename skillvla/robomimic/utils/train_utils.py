...
import skillvla.robomimic.utils.log_utils as LogUtils
import skillvla.robomimic.utils.file_utils as FileUtils

from skillvla.robomimic.utils.dataset import SequenceDataset, DROIDDataset, MetaDataset
from skillvla.robomimic.envs.env_base import EnvBase
from skillvla.robomimic.envs.wrappers import EnvWrapper
from skillvla.robomimic.algo import RolloutPolicy
...
def get_exp_dir(config, auto_remove_exp_dir=False):
    ...
    if not os.path.isabs(base_output_dir):
        ...
        base_output_dir = os.path.join(skillvla.robomimic.__path__[0], base_output_dir)
